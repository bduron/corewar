...
/*   Updated: 2017/04/23 17:07:11 by pboutelo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "corewar.h"

void	op_zjmp(t_vm *v, t_list *process) // VERBOSE DONE
{
	int shift;
...
void	op_fork(t_vm *v, t_list *process) // VERBOSE DONE
{
	int shift;
...
void	op_lfork(t_vm *v, t_list *process) // VERBOSE DONE
{
	int shift;
